...
def send_news():
    ...
    if 1:
        ...
        if 1:
            ...
            my_friends=itchat.search_friends(name=u'李丽江')#备注就可以了
...
if __name__=='__main__':
    while True:
        ...
        #if love_time == "22:36:15":#一直挂着就是每天这个点发送，如果想每个小时都发送，可以考虑在条件那里用到‘或’条件，不过不美观，建议提取时与分出来，直接切除前面几个字符love_time[3:8]就可以了
        if 1:
            #main()
            send_news()
            time.sleep(60)
